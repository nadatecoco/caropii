...
struct ExerciseDetailView: View {
    ...
    // 追加: 現在フォーカスされているセットのインデックスと値
    @State private var focusedSetIndex: Int? = nil
    @State private var focusedWeight: String = ""
    @State private var focusedReps: String = ""
    @FocusState private var keyboardFocused: KeyboardField?
